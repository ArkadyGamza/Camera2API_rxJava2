...
@TargetApi(21) class CameraOrientationHelper {
   ...
   */
  static int getJpegOrientation(@NonNull CameraCharacteristics characteristics,
      int screenRotation) {
   ...
   */
  public static Size getSensorSizeRotated(@NonNull CameraCharacteristics characteristics,
