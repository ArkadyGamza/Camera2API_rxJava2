 ...
 */
@TargetApi(21) class ImageSaverRxWrapper {
  ...
  @NonNull
  public static Observable<ImageReader> createOnImageAvailableObservable(
    ...
    return Observable.create(subscriber -> {
      ...
      subscriber.setCancellable(() -> imageReader
          .setOnImageAvailableListener(null, null)); //remove listener on unsubscribe
    });
  }
}
