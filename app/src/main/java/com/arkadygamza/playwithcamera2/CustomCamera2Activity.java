...
public class CustomCamera2Activity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    findViewById(R.id.customCameraActivity_takePhoto)
        .setOnClickListener(view -> mRxCameraController21.takePhoto());
    findViewById(R.id.customCameraActivity_switchCamera)
        .setOnClickListener(view -> mRxCameraController21.switchCamera());
  ...
  private final CameraController.Callback mRxCamerController21Callback = new CameraController.Callback() {
    ...
    public void onPhotoTaken(@NonNull String photoUrl, @NonNull Integer photoSourceType) {
      Intent intent = ShowPhotoActivity.IntentHelper
          .createIntent(CustomCamera2Activity.this, photoUrl);
